...
t_2_values = [0, 0.1, 0.2]  # Values of t2 to test
...
for factor in t_2_values:
    ...
    plt.title(f'linearly polaralized probe pulse, wavelength = {wavelength_um} nm, size of flake = {m}, A_0 = {A_0}, t2 = {factor}')
    plt.savefig(f'pump_prob_t_2_{factor}_{random_number}.pdf')
