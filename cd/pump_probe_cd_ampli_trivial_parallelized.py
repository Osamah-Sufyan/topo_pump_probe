...
def pump_probe(t1,t2, Delta, A_0_1, A_0_2,helicity):
    print(f"Processing Amp = {A_0_1}")
    ...
    cd_1 = (integral_1_r - integral_1_l)/ (integral_1_r + integral_1_l)
    cd_2 = (integral_5_r - integral_5_l)/ (integral_5_r + integral_5_l)
    cd_3 = (integral_7_r - integral_7_l)/ (integral_7_r + integral_7_l)

    
    return cd_1, cd_2, cd_3

# parallelize the pump_probe function iterating amplitudes
