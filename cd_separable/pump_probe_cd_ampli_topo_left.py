...
amplitudes = np.arange(0, 0.1, 0.01)
...
for ind, trial in enumerate(amplitudes):
    ...
    integral_1_r = np.trapezoid(total_intensity_right[:harmonic_10_index], positive_frequencies[:harmonic_10_index])
    integral_5_r = np.trapezoid(total_intensity_right[harmonic_10_index - 5:harmonic_10_index + 5],
                          positive_frequencies[harmonic_10_index - 5:harmonic_10_index + 5])
    integral_7_r = np.trapezoid(total_intensity_right[harmonic_10_index - 7:harmonic_10_index + 7],
...
plt.savefig(f'../plots/circular_dichroism_vs_amplitude_topo_left.pdf')
plt.show()
