...
vertical_edge_indices1 = vertical_edge_indices1 + vertical_edge_indices2
...
average_J_y = np.mean(J_y_multiplied[-2000:])
...
# save current_x and current_y to csv file for each run of amplitude as separate row




csv_filename = "../data/new_currents/current_A0_left_t2_0.03.csv"
file_exists = os.path.isfile(csv_filename)

with open(csv_filename, 'a') as f:
    if not file_exists:
        f.write("A0, current_x, current_y\n")  # Write header if file doesn't exist
    f.write(f"{A_0}, {average_J_x}, {average_J_y}\n")